...
When any edit is material, stop. Show only the material items, each as "agreed in dialogue: … / now in spec: …", and ask whether to accept or revert. Revert what your human partner rejects, commit, and invoke writing-plans; a reverted edit does not go back through review, because it restores text the review had already seen.
