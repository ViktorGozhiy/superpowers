...
assert_contains "$REVIEWING_SKILL" "check-ignore" "reviewing-documents handles git-ignored documents"
...
assert_contains "$DELEGATING_SKILL" "check-ignore" "delegating-execution handles a git-ignored brief"
assert_contains "$BRIEF_TEMPLATE" "check-ignore" "brief template handles a git-ignored report"
